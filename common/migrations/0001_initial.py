# Generated by Django 2.2.6 on 2020-06-29 11:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_id', models.ForeignKey(on_delete=False, to='common.Goods', verbose_name='商品id号')),
                ('order_id', models.ForeignKey(on_delete=False, to='common.Orders', verbose_name='订单id号')),
            ],
            options={
